                    ...
                    <div>
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-2 bg-white dark:bg-gray-800 text-gray-500">continue with</span>
                            </div>
                        </div>

                        <div className="mt-4 w-full flex flex-col gap-2">
                            <button onClick={() => handleLogin("google")} className="w-full py-2.5 rounded-md bg-indigo-600 hover:bg-indigo-700 text-white font-semibold shadow-sm">
                                Login with Google
                            </button>
